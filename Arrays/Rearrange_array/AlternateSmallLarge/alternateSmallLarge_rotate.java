/*
Arrange array such that, resultant contains ,alternate small number, large number
Time=O(n^2)
Space=O(1)
 */
package RBR_DSA;
...
public class alternateSmallLarge_rotate {
    public static void smallLarge(int[] arr,int n)
    {
    ...
    public static void main(String[] args)
    {
        ...
        smallLarge(testCase1,6);
        display(testCase1);

        int testCase2[]={-1,-2,-5,-3,4};
        smallLarge(testCase2,5);
        display(testCase2);
    }
}
